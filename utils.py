...
import copy
import ember_class_task_exps.original_data as original_data
from encoder import Classifier, DFNet
...
def v1_get_data_loader(dataset, batch_size, cuda=False, collate_fn=None, drop_last=False, augment=False):
    ...
    if augment:
        ...
        dataset_.transform = transforms.Compose([dataset.transform, *original_data.AVAILABLE_TRANSFORMS['augment']])
    else:
        dataset_ = dataset
...
def get_data_loader(dataset, batch_size, cuda=False, collate_fn=None, drop_last=False, augment=False):
    ...
    #print("DEBUG: samples_weight shape:", samples_weight.shape)
    #print("DEBUG: samples_weight first 10 values:", samples_weight[:10])
    #print("DEBUG: num_samples:", len(samples_weight))
