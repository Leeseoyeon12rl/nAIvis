...
parser.add_argument('--data-dir', type=str,\
                    default='/home/swu/continual-learning-malware/top_classes_100/',\
                    dest='d_dir', help="default: %(default)s")
...
def run(args, verbose=True):
    ...
    else: model = DFNet(input_size=config['size'], num_classes=config['classes']).to(device)
    ...
    train_cl(
        ...
        iters=args.iters, batch_size=min(128, args.batch),
